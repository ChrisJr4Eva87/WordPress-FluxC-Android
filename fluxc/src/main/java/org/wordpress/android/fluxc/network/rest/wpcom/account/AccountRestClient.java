...
public class AccountRestClient extends BaseWPComRestClient {
    ...
    public static class AccountFetchUsernameSuggestionsResponsePayload extends
        ...
        public AccountFetchUsernameSuggestionsResponsePayload(JSONArray suggestions) {
            this.suggestions = convertJsonArrayToStringList(suggestions);
        }
        ...
        private List<String> convertJsonArrayToStringList(JSONArray array) {
            ...
            if (array != null) {
                try {
                    ...
                    AppLog.e(T.API, "Unable to parse username suggestions: " + exception.getMessage());
                }
            }
